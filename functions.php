...
//https://justintadlock.com/archives/2009/05/09/using-shortcodes-to-show-members-only-content//
...
function check_user_login() {
    if ( ! is_user_logged_in() ) {
        wp_redirect( 'https://paki91.com/wp-login.php' );
        exit;
    } else {
        return '';
    }
}
add_shortcode( 'check_login', 'check_user_login' );
